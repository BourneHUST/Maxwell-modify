...
public class BinlogConnectorReplicator extends RunLoopProcess implements Replicator, BinaryLogClient.LifecycleListener {
	...
	public void addFilter(String filterString) throws Exception {
		LOGGER.info("add filter, before add: " + filter.toString());
		this.filter.addRule(filterString);
		LOGGER.info("after add: " + filter.toString());
	}

	public void removeFilter(String filterString) throws Exception {
		LOGGER.info("remove filter, before remove: " + filter.toString());
		this.filter.removeRule(filterString);
		LOGGER.info("after remove: " + filter.toString());
	}
